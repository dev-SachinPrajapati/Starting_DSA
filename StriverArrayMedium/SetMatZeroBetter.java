...
public class SetMatZeroBetter {
	public static ArrayList<ArrayList<Integer>> ZeroMat(ArrayList<ArrayList<Integer>> matrix, int n, int m){ 
	...
	public static void main(String[] args) {
		...
		ArrayList<ArrayList<Integer>> ans = ZeroMat(matrix, n, m);
